  ...
  return (
    ...
    <section className="relative h-screen overflow-hidden bg-[#f7f4ff] flex items-center justify-center">
      ...
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-[30px] md:text-[50px] leading-[0.96] font-black tracking-[-0.06em] text-[#020617]"
        >
          Scale Your
          <br />
          Amazon Brand
        ...
        >
          GAIN helps brands grow profitably through Amazon PPC,
          listing optimization, A+ content, and performance-focused
        ...
        >
          <Link
            ...
            className="bg-[#6d28d9] hover:bg-[#5b21b6] text-white text-[14px] font-medium px-8 py-4 rounded-2xl transition-all duration-300 shadow-lg shadow-purple-300/30 inline-flex items-center justify-center hover:-translate-y-0.5"
          >
