    ...
    <main className="overflow-hidden bg-[#f4f3ff] min-h-screen flex flex-col justify-between">
      ...
      <div className="relative flex-grow flex items-center justify-center py-20 px-6">
        ...
        <div className="relative z-10 max-w-xl w-full text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-[#eceaff] border border-[#e2dfff] rounded-full px-4 py-1.5 mb-8 shadow-sm">
          ...
          {/* Subheading */}
          <p className="mt-6 text-slate-700 text-sm md:text-base leading-relaxed max-w-md mx-auto">
          ...
          {/* Notify Form */}
          <div className="mt-8 bg-white border border-[#e2dfff] rounded-3xl p-6 md:p-8 shadow-xl shadow-purple-900/5">
            {!submitted ? (
